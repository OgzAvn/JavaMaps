package com.oguz.javamaps.adapter;
...
import com.oguz.javamaps.databinding.RecyclerRowBinding;
import com.oguz.javamaps.view.MapsActivity;
...
public class PlaceAdapter extends RecyclerView.Adapter<PlaceAdapter.PlaceHolder> {
    ...
    public class PlaceHolder extends RecyclerView.ViewHolder{
        ...
        public PlaceHolder(@NonNull RecyclerRowBinding recyclerRowBinding) {
            super(recyclerRowBinding.getRoot());//View i böyle alıyoruz.??? Furkana sor!!
